...

  ...
  \draw ( 0, 5pt) node[above, font=\footnotesize]{$
    \xrightarrow[\textcolor{\PC}{\ADD_d^{\vphantom{z'}}}]{\mbox{\tiny{before}}}
    \xrightarrow[\textcolor{\PH}{\ADD_h^{z\vphantom{'}}}]{\mbox{\tiny{last}}}
    \xrightarrow[\DEL_h^{\vphantom{z'}} ]{\mbox{\tiny{expect}}}$};
  
  \draw ( \X, 5pt) node[above, font=\footnotesize]{$
    \xrightarrow[\textcolor{\PH}{\ADD_h^{\vphantom{y'}}} \rightarrow \DEL_h]{\mbox{\tiny{before}}}
    \xrightarrow[\textcolor{\PC}{\ADD_d^{y'}}]{\mbox{\tiny{last}}}
    \xrightarrow[\DEL_d^{\vphantom{z'}}?]{\mbox{\tiny{expect}}}$};

  \draw (2*\X, 5pt) node[above, font=\footnotesize]{$
    \xrightarrow[\textcolor{\PC}{\ADD_d^{y''}}]{\mbox{\tiny{last}}}
    \xrightarrow[\DEL_d^{\vphantom{y'}}?]{\mbox{\tiny{expect}}}$};
