...
\begin{figure*}
\centering
\subfloat[\Process~$R$ efficiently advertises its content by epidemic propagation. Every \process requests $R$ if needed.\label{fig:partition_intuitionA}]{\includegraphics[trim=6cm 0.33cm 6cm 0.33cm, clip, width=0.24\textwidth]{img/Dynamic-partitioning-1.png}}
\hfill
