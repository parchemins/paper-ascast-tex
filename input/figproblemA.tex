...

  ...
  \draw (-\X + 5pt, 0) --
  node[above=-0.3em,font=\tiny]{$\DEL_a \cdot \textcolor{\PA}{\ADD_{a}^{2}} \rightarrow$}
  (0 - 5pt, 0); %% b - a 
  ...
  \draw (\X + 3pt, 0 - 5pt) --
  node[above=-0.3em, font=\tiny, sloped]{$\DEL_d\cdot\textcolor{\PD}{\ADD_{d}^{3}} \rightarrow$}
  (0 + 5pt, \Y - 3pt); %% c - d
...

  ...
  \draw ( 0pt, \Y -5pt) node[below, font=\scriptsize]{$\textcolor{\PC}{\ADD_d} \rightarrow \DEL_d \vphantom{\ADD_a^3}$};
