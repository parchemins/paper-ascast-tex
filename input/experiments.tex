...
In this section, we discuss the evaluations conducted on PeerSim, a
simulator that allows researchers to evaluate and assess distributed
algorithms in large scale networks~\cite{montresor2009peersim}. All
the code is available on the Github platform at
\mbox{\url{https://github.com/ane-wane/as-cast}}.
