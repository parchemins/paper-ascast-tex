...
These approaches are in contradiction with the objectives of Edge
...
\item [$\bullet$] We evaluate \NAME with simulations. Our experiments
  ...
  also highlight the relevance of \NAME in autonomous systems. \NAME
  would allow to lock down the traffic generated by content indexing,
  even in contexts where \emph{physical} partitioning may occur.
  As such, \NAME can constitute a new building block for geo-distributed
  services.
\end{asparadesc}
