...
follows. Sec.~\ref{sec:background} illustrates the motivation and
problem behind our proposal.  Sec.~\ref{sec:adaptive} describes
dynamic consistent partitioning and its
implementation. Sec.~\ref{sec:experimentation} presents our
evaluations.  Sec.~\ref{sec:related_work} reviews related
work. Finally, Sec.~\ref{sec:conclusion} concludes and discusses
future work.
