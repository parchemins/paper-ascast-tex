...
\TODO{Add something about the fact that in addition to the location service of the replica, we need a service that maintain a view of the infrastructure topology so that each node can infer which replica is the closest one.}
...
\TODO{Explain that the problem can be seen as a graph partitioning problem}
