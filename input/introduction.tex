...
closest partition. Periodic advertisement protocols \note{Why a periodic protocol solves the ''correct cast/scope''? I miss the point here}
already provide both operations~\cite{hemmati2015namebased,sohier2012physarum}. However,
...
\item [$\bullet$] We provide an implementation entitled \NAME that
 ...
 \note{AS-Cast stands for Autonomous System-Cast since xAS means cross AS? what did I miss?}
...
\note{More detail, name drop that we can support CDN.}
\note{Why C/P abstract sentence here? I would rather skip here and C/P and complete in the conclusion?}
