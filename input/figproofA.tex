...

  ...
  \draw ( 0, 5pt) node[above]{$
    \xrightarrow[\textcolor{\PD}{\ADD_d^y}]{\mbox{\tiny{last}}}
    \xrightarrow[\DEL_d \rightarrow \textcolor{\PA}{\ADD_a^{x'}}]{\mbox{\tiny{expect}}}$};
  ...
  \draw (\X, 5pt) node[above]{$
    \xrightarrow[\textcolor{\PA}{\ADD_a^{x''}}]{\mbox{\tiny{expect}}}$};
