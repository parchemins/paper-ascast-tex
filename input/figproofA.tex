...

  ...
  \draw[<->] (5pt - \X, 0.4*\Y) -- node[below, font=\small]{\textbf{I: propagation}} (-5pt, 0.4*\Y); %% I
...

  ...
  \draw[->] ( 0,  0.5*\Y) -- ( 0, -5pt);
  \draw[dotted] ( 0,  0.5*\Y) -- ( 0, 0.9*\Y) node[below, font=\scriptsize]{somewhere: $\textcolor{\PD}{\ADD_d} \rightarrow \DEL_d$};
