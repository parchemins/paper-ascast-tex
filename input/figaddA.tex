...

  ...
  \draw (-\X + 5pt, 0) --
  node[shape=circle, draw, fill=white, inner sep=0.5px, font=\footnotesize]{2}
  (0 - 5pt, 0); %% a - b

  \draw (0 +5pt, 0) --
  node[shape=circle, draw, fill=white, inner sep=0.5px, font=\footnotesize]{1}
  (\X -5pt, 0); %% b - c
  ...
  \draw (\X + 3pt, 0 - 5pt) --
  node[shape=circle, draw, fill=white, inner sep=0.5px, font=\footnotesize]{3}
  (0 + 5pt, \Y - 3pt); %% c - d
