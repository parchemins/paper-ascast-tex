...
challenge of content indexing, a key service for storage systems, as a
dynamic logical partitioning problem where partitions grow and shrink
to reflect content and replicas locations, as well as infrastructure
changes.
...
best replica of a specific content.  The challenge resides in handling
...
briefly discussed an improvement to contain the traffic in relevant
autonomous systems.
...
\noindent As future work, we plan to evaluate \NAME within a concrete
...
\note{Parler de l'application au CDN (voir tex)}
