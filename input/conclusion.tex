...
to enable lazy retrieval of partitions \TODO{when a large number of
  objects is involved}. Indeed, using \NAME, every \process partakes
in the propagation of indexes \TODO{which raises scalability
  issues}. We would like to leverage the hierarchical properties of
