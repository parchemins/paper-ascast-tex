...
to enable lazy retrieval of partitions when a large number of
\TODO{objects} is involved. Indeed, using \NAME, every \process
partakes in the propagation of indexes which raises scalability
