...
%% Dedicated scoped broadcast implementations
%% outperform uniform reliable broadcast
%% implementations~\cite{hadzilacos1994modular, raynal2013distributed}
%% since the former targets a connected \emph{subset} of the whole
%% network while the latter targets \emph{all} \processes of the
%% distributed system.
...
using \NAMEB itself for the sake of efficiency. \TODO{States of
  \processes change, predicates change over time.} At any time, a
