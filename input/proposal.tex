...
\subsection{Lazy partitioning}
\label{subsec:lazy}

Edge infrastructures are networks of autonomous systems. Autonomous
systems that do not host any sources should not generate traffic. 
