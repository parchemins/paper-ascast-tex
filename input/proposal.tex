...
not forwarding farther but up-to-date messages from actual sources.
...
$\delta$ and therefore $\delta_a$.  \TODO{Must take action because its
  parent has forwarded something already stale so previous cannot be
  good.}
