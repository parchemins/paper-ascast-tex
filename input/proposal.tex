...
of versions that monotonically increases over \TODO{add and del}
...
competition amongst neighboring partitions. These \TODO{add}
...
\TODO{undo} all add messages originated from this process. \TODO{Why
  distance is not sufficient ?} \TODO{Why not use this from the first
  step then, or why other steps are still relevant?} 

\paragraph{A last optimisation}

\TODO{Carry information that is useless. such as order of processes in
  paths, and identities of processes themselves.}

\subsection{Complexity}
\label{subsec:complexity}

\TODO{To rework, for there are more components now.}
