...
\begin{proof}
  ...
  \item [Purge not followed by BEF:]
    ...
    it becomes stale ($S(\alpha_a^x) \implies d_b(\alpha_a^x)
  ...
  \item [Purge then BEF:] Assuming the eventual and definitive removal
    ...
    forwarding of best delivered messages, every \processes eventually
    delivers and forwards the best up-to-date delivered
    messages. \Processes reach consistent partitioning together.
...
\TODO{The challenge is therefore about purging.} 
