...
\TODO{Write and describe algo.} \TODO{Overhead of separating things,
  ...
  it keeps it for links of rank 0, and links of rank 1.}

The rest of this section describes our proposal to solve these smaller
scientific problems. It first tackles dynamic partitions where
processes can add or delete partitions resulting in stale information
that may impair correctness. It then tackles dynamic networks where
edges appear and disappear at any time resulting in invalid
information that may impair correctness.
...
requires each \TODO{delete} message to piggyback a source identifier
and version number.
