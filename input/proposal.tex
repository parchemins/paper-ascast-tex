...
can stop forwarding messages as soon as its predicate becomes
unverified.
...
\begin{theorem}[\label{theo:efb}\underline{F}orwarding of \underline{B}est (FB)
    ...
    reach consistent partitioning if each \process delivers its best
    message among \underline{r}eceived messages $R_x$, and forwards
    its best message among \underline{d}elivered messages $D_x$.
    % , \ie
...
\begin{proof}
  ...
  delivers it, since $|\Pi_{sq}| < |\Pi_{s'q}|$.
  %
