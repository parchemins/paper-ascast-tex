...
\begin{figure*}
  ...
  \begin{center}
    ...
    \hspace{5pt}
    \subfloat[Part D][\label{fig:problemD}\TODO{$b$ blocks the only transiting
      $\delta_a$ while $b$ delivers and forwards $\alpha_c$.}]
             {\input{input/figsimplerproblemD.tex}}
    \hspace{5pt}
    \subfloat[Part E][\label{fig:problemE}\TODO{$b$ blocks the only transiting
      $\delta_a$ while $b$ delivers and forwards $\alpha_c$.}]
             {\input{input/figsimplerproblemE.tex}}
    \hspace{5pt}
    \subfloat[Part F][\label{fig:problemF}$b$ delivers and forwards $\delta_c$. $c$
