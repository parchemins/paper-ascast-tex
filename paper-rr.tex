...
\RRtitle{\NAME : Confiner le trafic de l'indexation de contenu décentralisée au niveau du Edge} %% titre français long
\titlehead{\RRtitle{} } %% titre français court
...
\RRmotcle{Indexation de contenu, partitionnement logique, algorithme décentralisé}
\RRkeyword{Content indexing, logical partitioning, decentralized algorithm}
