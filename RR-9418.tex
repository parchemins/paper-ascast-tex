...
\titlehead{\NAME : Lock Down the Traffic of Decentralized Content Indexing at the Edge}
...
\RRnote{This preprint has not undergone peer review or any
  post-submission improvements or corrections. The Version of Record
  of this contribution is published in \emph{Algorithms and
  Architectures for Parallel Processing (LNCS volume 13777)}, and is
  available online at
  \url{https://doi.org/10.1007/978-3-031-22677-9_23}}

%% \RRnote{This version of the contribution has been accepted for
%%   publication, after peer review (when applicable) but is not the
...
%%   http://dx.doi.org/[insert DOI]. Use of this Accepted Version is
%%   subject to the publisher’s Accepted Manuscript terms of use
